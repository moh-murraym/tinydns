...
def save(data, filename, mode=0o600, safe=False):
    ...
    """
    if safe is True and (os.name != 'posix' or not os.path.exists(filename)):
...
def save_object(obj, file_name, mode=0o600, safe=False):
